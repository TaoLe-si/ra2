...
| **L2 关系** | ◐ **CFG 已完成**（S2：203,071 块 / 287,359 边，独立对账 40/40）；**调用图与签名**（S3）盘点已做：**68,207** 处直接调用点、**16,402** 条 `ret imm`（参数字节自证）、**161,057** 条 `push`（第二个独立来源）、虚表 1,209 张 / 14,035 槽；`tools/callscan.py` 未开工 |
